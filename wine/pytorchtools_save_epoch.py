...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, path='/content/drive/MyDrive/Xiyuan Chang Drexel senior design/term 3/wine/code/models/bilstm_attention/epoch_checkpoint.pt', trace_func=print):
        """
        Args:
